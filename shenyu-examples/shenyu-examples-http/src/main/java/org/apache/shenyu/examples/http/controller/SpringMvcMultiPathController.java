 ...
 * Both /multipath/v1 and /multipath/v2 prefixes are registered via a single annotation.
 */
@RestController
@RequestMapping({"/multipath/v1", "/multipath/v2"})
@ShenyuSpringMvcClient(path = {"/multipath/v1", "/multipath/v2"}, desc = "multi path register")
