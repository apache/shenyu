...
package org.apache.shenyu.examples.springcloud.configuration;
...
public class SwaggerConfiguration {
    ...
    private static final String TITLE = "shenyu-examples-springcloud API";

    private static final String DESCRIPTION = "shenyu-examples-springcloud API";
    ...
    public Docket createRestApi() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
            ...
            .select()
            .apis(RequestHandlerSelectors.basePackage("org.apache.shenyu.examples.springcloud.controller"))
