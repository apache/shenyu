...
public class IngressConstants {
    ...
    // The configuration key to specify whether to use the Motan plugin, in string
    public static final String PLUGIN_MOTAN_ENABLED = "shenyu.apache.org/plugin-motan-enabled";

    // The configuration key to specify the Motan context path for the plugin, in string
    public static final String PLUGIN_MOTAN_CONTEXT_PATH = "shenyu.apache.org/plugin-motan-context-path";

    // The configuration key to specify the Motan app name for the plugin, in string
    public static final String PLUGIN_MOTAN_APP_NAME = "shenyu.apache.org/plugin-motan-app-name";

    // The configuration key to specify the Motan method name for the plugin, in string
    public static final String PLUGIN_MOTAN_METHOD_NAME = "shenyu.apache.org/plugin-motan-method-name";

    // The configuration key to specify the Motan path for the plugin, in string
    ...
    // The configuration key to specify the Motan RPC type for the plugin, in string
    public static final String PLUGIN_MOTAN_RPC_TYPE = "shenyu.apache.org/plugin-motan-rpc-type";

    // The configuration key to specify the Motan parameter types for the plugin, in string
    public static final String PLUGIN_MOTAN_PARAMS_TYPE = "shenyu.apache.org/plugin-motan-params-type";

    // The configuration key to specify additional RPC extension for the Motan plugin, in string
