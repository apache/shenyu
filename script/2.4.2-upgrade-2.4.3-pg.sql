...
INSERT INTO plugin_handle (id, plugin_id, field, label, data_type, type, sort, ext_obj) VALUES ('1505398085349310464', '1505394366310285312', 'database', 'database', 1, 3, 2, '{"required":"0","defaultValue":"0","rule":""}');
INSERT INTO plugin_handle (id, plugin_id, field, label, data_type, type, sort, ext_obj) VALUES ('1505398320372940800', '1505394366310285312', 'master', 'master', 2, 3, 3, '{"required":"0","rule":""}');
INSERT INTO plugin_handle (id, plugin_id, field, label, data_type, type, sort, ext_obj) VALUES ('1505398496462405632', '1505394366310285312', 'mode', 'mode', 2, 3, 4, '{"required":"0","defaultValue":"standalone","rule":""}');
INSERT INTO plugin_handle (id, plugin_id, field, label, data_type, type, sort, ext_obj) VALUES ('1505398640738074624', '1505394366310285312', 'url', 'url', 2, 3, 5, '{"required":"0","rule":""}');
INSERT INTO plugin_handle (id, plugin_id, field, label, data_type, type, sort, ext_obj) VALUES ('1505398799370846208', '1505394366310285312', 'password', 'password', 2, 3, 6, '{"required":"0","rule":""}');
