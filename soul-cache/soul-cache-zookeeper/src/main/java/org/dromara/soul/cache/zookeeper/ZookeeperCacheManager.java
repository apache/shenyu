...
package org.dromara.soul.cache.zookeeper;
...
import org.dromara.soul.cache.api.CommonCacheHandler;
 ...
 * @author xiaoyu
 */
public class ZookeeperCacheManager extends CommonCacheHandler implements AutoCloseable {

    private final ZkClient zkClient;
    
    private final List<PluginDataSubscriber> pluginDataSubscribers;
     ...
     */
    public ZookeeperCacheManager(final ZkClient zkClient, final List<PluginDataSubscriber> pluginDataSubscribers, final List<MetaDataSubscriber> metaDataSubscribers) {
        this.zkClient = zkClient;
        this.pluginDataSubscribers = pluginDataSubscribers;
    ...
    private void watcherPlugin(final String pluginName) {
        ...
        Optional.ofNullable(pluginData).ifPresent(data -> {
            pluginDataSubscribers.forEach(e-> e.onSubscribe(data));
            ...
            public void handleDataChange(final String dataPath, final Object data) {
                Optional.ofNullable(data)
                        .ifPresent(d -> {
                            ...
                            pluginDataSubscribers.forEach(e-> e.onSubscribe(pluginData));
        ...
        zkClient.subscribeDataChanges(path, new IZkDataListener() {
            ...
            public void handleDataDeleted(final String dataPath) {
                ...
                Optional.of(key).ifPresent(k -> {
                    ...
                    UpstreamCacheManager.getInstance().removeByKey(k);
                });
            }
        });
    }
