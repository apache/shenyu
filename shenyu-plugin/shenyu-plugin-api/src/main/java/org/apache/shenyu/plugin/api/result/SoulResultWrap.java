...
public final class SoulResultWrap<T> {
    ...
    public static Object success(final int code, final String message, final Object object) {
        return SpringBeanUtils.getInstance().getBean(SoulResult.class).success(code, message, object);
    }
    ...
    public static Object error(final int code, final String message, final Object object) {
        return SpringBeanUtils.getInstance().getBean(SoulResult.class).error(code, message, object);
    }
}
