...
public class AuthConfig{
    ...
    public AuthConfig(final String endpoint, final String clientId, final String clientSecret, final String certificate, final String organizationName, final String applicationName) {
