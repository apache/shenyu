...
// Go WASM handler for AbstractWasmDiscoveryHandler.
// Exports handlerDiscoveryUpstreamData — (i64) -> ().
...
//go:wasmexport handlerDiscoveryUpstreamData
func handlerDiscoveryUpstreamData(argId int64) {
	buf := make([]byte, 1024)
