...
public class BinderTest {
    ...
    public void testBind() {
        ...
        PropertySource<?> propertySource = new OriginTrackedMapPropertySource(name, map);
        ...
        BindData<BaseConfig> data = new BindData<>(BaseConfig.class, BaseConfig.class, BaseConfig::new);
