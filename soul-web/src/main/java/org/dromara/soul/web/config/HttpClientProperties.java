 ...
 */
@ConfigurationProperties("soul.httpclient")
public class HttpClientProperties {
    ...
    public class Ssl {
         ...
         *
         * @param trustedX509 the trusted x 509
         */
        public void setTrustedX509Certificates(final List<String> trustedX509) {
        ...
        /**
         * Gets handshake timeout millis.
         *
         * @return the handshake timeout millis
         */
        @DeprecatedConfigurationProperty(replacement = "soul.ssl.handshake-timeout")
        @Deprecated
        ...
        /**
         * Sets handshake timeout millis.
         *
         * @param handshakeTimeoutMillis the handshake timeout millis
         */
        @Deprecated
        ...
        /**
         * Gets close notify flush timeout millis.
         *
         * @return the close notify flush timeout millis
         */
        @DeprecatedConfigurationProperty(replacement = "soul.httpclient.ssl.close-notify-flush-timeout")
        @Deprecated
        ...
        /**
         * Sets close notify flush timeout millis.
         *
         * @param closeNotifyFlushTimeoutMillis the close notify flush timeout millis
         */
        @Deprecated
        public void setCloseNotifyFlushTimeoutMillis(final long closeNotifyFlushTimeoutMillis) {
            setCloseNotifyFlushTimeout(Duration.ofMillis(closeNotifyFlushTimeoutMillis));
        }

        /**
         * Gets close notify read timeout millis.
         *
         * @return the close notify read timeout millis
         */
        @DeprecatedConfigurationProperty(replacement = "soul.httpclient.ssl.close-notify-read-timeout")
        @Deprecated
        ...
        /**
         * Sets close notify read timeout millis.
         *
         * @param closeNotifyReadTimeoutMillis the close notify read timeout millis
         */
        @Deprecated
        public void setCloseNotifyReadTimeoutMillis(final long closeNotifyReadTimeoutMillis) {
