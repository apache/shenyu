 ...
 * @author xiaoyu(Myth)
 */
public final class ConditionStrategy {


    /**
     * judge conditions with and strategy .
     *
     * @param conditionZkDTOList conditions
     * @param exchange           exchange
     * @return True is pass False is Not pass
     */
    public static Boolean and(final List<ConditionZkDTO> conditionZkDTOList, final ServerWebExchange exchange) {
    ...
    /**
     * judge conditions with or strategy .
     *
     * @param conditionZkDTOList conditions
     * @param exchange           exchange
     * @return True is pass False is Not pass
     */
    public static Boolean or(final List<ConditionZkDTO> conditionZkDTOList, final ServerWebExchange exchange) {
        return conditionZkDTOList
                .stream()
                .anyMatch(condition -> ConditionJudge.judge(condition, buildRealData(condition, exchange)));
    }

    private static String buildRealData(final ConditionZkDTO condition, final ServerWebExchange exchange) {
        String realData = "";
