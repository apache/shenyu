 ...
 * @author xiaoyu
 */
public class LettuceClusterTypeClient implements LettuceTypeClient {

    private static final Logger LOGGER = LoggerFactory.getLogger(LettuceSentinelTypeClient.class);
     ...
     * @param pool the pool
     */
    LettuceClusterTypeClient(GenericObjectPool<StatefulRedisClusterConnection<String, String>> pool) {
        this.pool = pool;
    }
