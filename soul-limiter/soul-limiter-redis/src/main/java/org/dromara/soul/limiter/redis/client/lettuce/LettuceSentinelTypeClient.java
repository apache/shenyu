 ...
 * @author xiaoyu
 */
public class LettuceSentinelTypeClient implements LettuceTypeClient {

    private static final Logger LOGGER = LoggerFactory.getLogger(LettuceSentinelTypeClient.class);

    private GenericObjectPool<StatefulRedisConnection<String, String>> pool;

    LettuceSentinelTypeClient(GenericObjectPool<StatefulRedisConnection<String, String>> pool) {
        this.pool = pool;
    }
