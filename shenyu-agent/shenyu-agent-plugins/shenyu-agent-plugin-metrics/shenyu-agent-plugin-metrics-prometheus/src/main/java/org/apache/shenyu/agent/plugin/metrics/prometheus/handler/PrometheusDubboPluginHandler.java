...
/**
 * The type metrics prometheus dubbo plugin, about apache dubbo or alibaba dubbo, handler.
 */
public class PrometheusDubboPluginHandler implements InstanceMethodHandler {
    ...
    public void before(final TargetObject target, final Method method, final Object[] args, final MethodResult result) {
        ...
        MetricsRecorderPool.get(MetricsConstant.DUBBO_REQUEST_TOTAL, MetricsConstant.PROMETHEUS)
