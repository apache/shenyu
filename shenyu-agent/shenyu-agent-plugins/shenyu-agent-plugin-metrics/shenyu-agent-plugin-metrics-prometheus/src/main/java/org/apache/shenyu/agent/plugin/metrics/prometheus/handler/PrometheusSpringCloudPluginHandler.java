...
/**
 * The type metrics prometheus spring cloud plugin, about apache dubbo or alibaba dubbo, handler.
 */
public class PrometheusSpringCloudPluginHandler implements InstanceMethodHandler {
    ...
    public void before(final TargetObject target, final Method method, final Object[] args, final MethodResult result) {
        ...
        MetricsRecorderPool.get(MetricsConstant.SPRING_CLOUD_REQUEST_TOTAL, MetricsConstant.PROMETHEUS)
