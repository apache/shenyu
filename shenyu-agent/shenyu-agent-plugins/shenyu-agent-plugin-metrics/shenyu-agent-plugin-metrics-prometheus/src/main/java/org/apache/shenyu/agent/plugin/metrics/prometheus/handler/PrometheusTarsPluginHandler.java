...
/**
 * The type metrics prometheus tars plugin, about apache dubbo or alibaba dubbo, handler.
 */
public class PrometheusTarsPluginHandler implements InstanceMethodHandler {
    ...
    public void before(final TargetObject target, final Method method, final Object[] args, final MethodResult result) {
        ...
        MetricsRecorderPool.get(MetricsConstant.TARS_REQUEST_TOTAL, MetricsConstant.PROMETHEUS)
