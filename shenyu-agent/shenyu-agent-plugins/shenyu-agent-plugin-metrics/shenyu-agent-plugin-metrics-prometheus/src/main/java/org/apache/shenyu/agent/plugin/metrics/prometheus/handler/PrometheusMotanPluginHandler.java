...
/**
 * The type metrics prometheus motan plugin, about apache dubbo or alibaba dubbo, handler.
 */
public class PrometheusMotanPluginHandler implements InstanceMethodHandler {
    ...
    public void before(final TargetObject target, final Method method, final Object[] args, final MethodResult result) {
        ...
        MetricsRecorderPool.get(MetricsConstant.MOTAN_REQUEST_TOTAL, MetricsConstant.PROMETHEUS)
