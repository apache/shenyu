...
/**
 * The type metrics prometheus sofa plugin, about apache dubbo or alibaba dubbo, handler.
 */
public class PrometheusSofaPluginHandler implements InstanceMethodHandler {
    ...
    public void before(final TargetObject target, final Method method, final Object[] args, final MethodResult result) {
        ...
        MetricsRecorderPool.get(MetricsConstant.SOFA_REQUEST_TOTAL, MetricsConstant.PROMETHEUS)
