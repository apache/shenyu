    ...
    protected void handle(final String beanName, final Object bean) {
        ...
        if (superPath.contains("*") && Objects.nonNull(beanShenyuClient)) {
            ...
            for (Method method : methods) {
                this.getPublisher().publishEvent(buildMetaDataDTO(bean, beanShenyuClient, superPath, clazz, method));
            }
            return;
        }
        ...
        for (Method method : methods) {
            ...
            if (Objects.nonNull(shenyuMotanClient)) {
                this.getPublisher().publishEvent(buildMetaDataDTO(bean, shenyuMotanClient, superPath, clazz, method));
