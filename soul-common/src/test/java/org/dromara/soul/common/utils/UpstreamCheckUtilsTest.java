...
public final class UpstreamCheckUtilsTest {
    ...
    public void testSocketConnect() {
        Runnable runnable = () -> {
            ...
            try {
                serverSocket = new ServerSocket(3098);
        ...
        Thread.sleep(100);
        assertTrue(UpstreamCheckUtils.checkUrl("127.0.0.1:3098"));
        assertFalse(UpstreamCheckUtils.checkUrl("http://127.0.0.1:80"));
        assertTrue(UpstreamCheckUtils.checkUrl("http://127.0.0.1:3098"));
    }
}
