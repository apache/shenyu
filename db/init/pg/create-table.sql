...
COMMENT ON COLUMN "public"."rule"."match_restful" IS 'whether to match restful uri (0 no match, 1 match) ';
...
COMMENT ON COLUMN "public"."selector"."match_restful" IS 'whether to match restful uri';
