/*
 ...
 Source Server         : 达芬奇Test
 Source Server Type    : MySQL
 Source Server Version : 50720
 Source Host           : 10.190.12.162:3306
 Source Schema         : shenyu_master_0609

 Target Server Type    : MySQL
 Target Server Version : 50720
 File Encoding         : 65001

 Date: 09/06/2022 01:24:23
*/
...
CREATE TABLE `operation_record_log` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='operation record log';

-- ----------------------------
-- Records of operation_record_log
-- ----------------------------
BEGIN;
INSERT INTO `operation_record_log` VALUES (1, 'green', 'the resource [Documentation] is create', 'admin', '2022-06-09 00:44:32', 'CREATE:RESOURCE');
INSERT INTO `operation_record_log` VALUES (2, 'green', 'the resource [API document] is create', 'admin', '2022-06-09 00:47:45', 'CREATE:RESOURCE');
INSERT INTO `operation_record_log` VALUES (3, 'green', 'the resource [send] is create', 'admin', '2022-06-09 01:01:45', 'CREATE:RESOURCE');
INSERT INTO `operation_record_log` VALUES (4, 'red', 'the resource[send] is delete', 'admin', '2022-06-09 01:14:13', 'DELETE:RESOURCE');
INSERT INTO `operation_record_log` VALUES (5, 'red', 'the resource[API document] is delete', 'admin', '2022-06-09 01:14:18', 'DELETE:RESOURCE');
INSERT INTO `operation_record_log` VALUES (6, 'green', 'the resource [API document] is create', 'admin', '2022-06-09 01:15:49', 'CREATE:RESOURCE');
INSERT INTO `operation_record_log` VALUES (7, 'red', 'the resource[API document] is delete', 'admin', '2022-06-09 01:16:49', 'DELETE:RESOURCE');
INSERT INTO `operation_record_log` VALUES (8, 'green', 'the resource [API document] is create', 'admin', '2022-06-09 01:17:32', 'CREATE:RESOURCE');
INSERT INTO `operation_record_log` VALUES (9, 'green', 'the resource [send] is create', 'admin', '2022-06-09 01:17:57', 'CREATE:RESOURCE');
INSERT INTO `operation_record_log` VALUES (10, 'red', 'the resource[send] is delete', 'admin', '2022-06-09 01:23:20', 'DELETE:RESOURCE');
INSERT INTO `operation_record_log` VALUES (11, 'red', 'the resource[API document] is delete', 'admin', '2022-06-09 01:23:36', 'DELETE:RESOURCE');
INSERT INTO `operation_record_log` VALUES (12, 'red', 'the resource[Documentation] is delete', 'admin', '2022-06-09 01:23:41', 'DELETE:RESOURCE');
COMMIT;
