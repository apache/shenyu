...
CREATE TABLE `resource`  (
  ...
  `resource_name` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT 'route name',
  `resource_url` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT 'route url',
  ...
  `resource_sort` int(0) NOT NULL COMMENT 'sort',
