...
INSERT /*+ IGNORE_ROW_ON_DUPKEY_INDEX("resource" (id)) */ INTO "resource"  (id, parent_id, title, name, url, component, resource_type, sort, icon, is_leaf, is_route, perms, status) VALUES ('1792749362445840474', '1346776175553376256', 'SHENYU.MENU.SYSTEM.MANAGMENT.NAMESPACE', 'namespace', '/system/namespace', 'namespace', 1, 0, 'appstore', 0, 0, '', 1);
...
INSERT /*+ IGNORE_ROW_ON_DUPKEY_INDEX (namespace(id)) */ INTO `namespace` (`id`, `namespace_id`, `name`, `description`) VALUES ('1', '649330b6c2d74edcbe8e8a54df9eb385', 'default', 'default-namespace');
...
INSERT /*+ IGNORE_ROW_ON_DUPKEY_INDEX (plugin_ns_rel(id)) */ INTO plugin_ns_rel (id,namespace_id,plugin_id, config, sort, enabled) VALUES ('1801816010882822145','649330b6c2d74edcbe8e8a54df9eb385','1', NULL, 20, 0);
INSERT /*+ IGNORE_ROW_ON_DUPKEY_INDEX (plugin_ns_rel(id)) */ INTO plugin_ns_rel (id,namespace_id,plugin_id, config, sort, enabled) VALUES ('1801816010882822146','649330b6c2d74edcbe8e8a54df9eb385','10', NULL, 140, 0);
INSERT /*+ IGNORE_ROW_ON_DUPKEY_INDEX (plugin_ns_rel(id)) */ INTO plugin_ns_rel (id,namespace_id,plugin_id, config, sort, enabled) VALUES ('1801816010882822147','649330b6c2d74edcbe8e8a54df9eb385','11', '{"protocol":"zookeeper","register":"127.0.0.1:2181","threadpool":"shared"}', 310, 0);
INSERT /*+ IGNORE_ROW_ON_DUPKEY_INDEX (plugin_ns_rel(id)) */ INTO plugin_ns_rel (id,namespace_id,plugin_id, config, sort, enabled) VALUES ('1801816010882822148','649330b6c2d74edcbe8e8a54df9eb385','12', NULL, 310, 0);
INSERT /*+ IGNORE_ROW_ON_DUPKEY_INDEX (plugin_ns_rel(id)) */ INTO plugin_ns_rel (id,namespace_id,plugin_id, config, sort, enabled) VALUES ('1801816010882822149','649330b6c2d74edcbe8e8a54df9eb385','13', '{"multiSelectorHandle":"1","multiRuleHandle":"0","threadpool":"shared"}', 310, 0);
INSERT /*+ IGNORE_ROW_ON_DUPKEY_INDEX (plugin_ns_rel(id)) */ INTO plugin_ns_rel (id,namespace_id,plugin_id, config, sort, enabled) VALUES ('1801816010882822150','649330b6c2d74edcbe8e8a54df9eb385','14', NULL, 80, 1);
INSERT /*+ IGNORE_ROW_ON_DUPKEY_INDEX (plugin_ns_rel(id)) */ INTO plugin_ns_rel (id,namespace_id,plugin_id, config, sort, enabled) VALUES ('1801816010882822151','649330b6c2d74edcbe8e8a54df9eb385','15', '{"multiSelectorHandle":"1","multiRuleHandle":"0","threadpool":"shared"}', 310, 0);
INSERT /*+ IGNORE_ROW_ON_DUPKEY_INDEX (plugin_ns_rel(id)) */ INTO plugin_ns_rel (id,namespace_id,plugin_id, config, sort, enabled) VALUES ('1801816010882822152','649330b6c2d74edcbe8e8a54df9eb385','16', NULL, 110, 0);
INSERT /*+ IGNORE_ROW_ON_DUPKEY_INDEX (plugin_ns_rel(id)) */ INTO plugin_ns_rel (id,namespace_id,plugin_id, config, sort, enabled) VALUES ('1801816010882822153','649330b6c2d74edcbe8e8a54df9eb385','17', '{"registerProtocol":"direct","registerAddress":"127.0.0.1:2181","corethreads":0,"threads":2147483647,"queues":0,"threadpool":"shared"}', 310, 0);
INSERT /*+ IGNORE_ROW_ON_DUPKEY_INDEX (plugin_ns_rel(id)) */ INTO plugin_ns_rel (id,namespace_id,plugin_id, config, sort, enabled) VALUES ('1801816010882822154','649330b6c2d74edcbe8e8a54df9eb385','18', NULL, 160, 0);
INSERT /*+ IGNORE_ROW_ON_DUPKEY_INDEX (plugin_ns_rel(id)) */ INTO plugin_ns_rel (id,namespace_id,plugin_id, config, sort, enabled) VALUES ('1801816010882822155','649330b6c2d74edcbe8e8a54df9eb385','19', '{"secretKey":"key"}', 30, 0);
INSERT /*+ IGNORE_ROW_ON_DUPKEY_INDEX (plugin_ns_rel(id)) */ INTO plugin_ns_rel (id,namespace_id,plugin_id, config, sort, enabled) VALUES ('1801816010882822156','649330b6c2d74edcbe8e8a54df9eb385','2', '{"model":"black"}', 50, 0);
INSERT /*+ IGNORE_ROW_ON_DUPKEY_INDEX (plugin_ns_rel(id)) */ INTO plugin_ns_rel (id,namespace_id,plugin_id, config, sort, enabled) VALUES ('1801816010882822157','649330b6c2d74edcbe8e8a54df9eb385','20', NULL, 120, 0);
INSERT /*+ IGNORE_ROW_ON_DUPKEY_INDEX (plugin_ns_rel(id)) */ INTO plugin_ns_rel (id,namespace_id,plugin_id, config, sort, enabled) VALUES ('1801816010882822158','649330b6c2d74edcbe8e8a54df9eb385','21', NULL, 40, 0);
INSERT /*+ IGNORE_ROW_ON_DUPKEY_INDEX (plugin_ns_rel(id)) */ INTO plugin_ns_rel (id,namespace_id,plugin_id, config, sort, enabled) VALUES ('1801816010882822159','649330b6c2d74edcbe8e8a54df9eb385','22', NULL, 70, 0);
INSERT /*+ IGNORE_ROW_ON_DUPKEY_INDEX (plugin_ns_rel(id)) */ INTO plugin_ns_rel (id,namespace_id,plugin_id, config, sort, enabled) VALUES ('1801816010882822160','649330b6c2d74edcbe8e8a54df9eb385','23', NULL, 220, 0);
INSERT /*+ IGNORE_ROW_ON_DUPKEY_INDEX (plugin_ns_rel(id)) */ INTO plugin_ns_rel (id,namespace_id,plugin_id, config, sort, enabled) VALUES ('1801816010882822161','649330b6c2d74edcbe8e8a54df9eb385','24', NULL, 100, 1);
INSERT /*+ IGNORE_ROW_ON_DUPKEY_INDEX (plugin_ns_rel(id)) */ INTO plugin_ns_rel (id,namespace_id,plugin_id, config, sort, enabled) VALUES ('1801816010882822162','649330b6c2d74edcbe8e8a54df9eb385','25', NULL, 410, 1);
INSERT /*+ IGNORE_ROW_ON_DUPKEY_INDEX (plugin_ns_rel(id)) */ INTO plugin_ns_rel (id,namespace_id,plugin_id, config, sort, enabled) VALUES ('1801816010882822163','649330b6c2d74edcbe8e8a54df9eb385','26', '{"multiSelectorHandle":"1"}', 200, 1);
INSERT /*+ IGNORE_ROW_ON_DUPKEY_INDEX (plugin_ns_rel(id)) */ INTO plugin_ns_rel (id,namespace_id,plugin_id, config, sort, enabled) VALUES ('1801816010882822164','649330b6c2d74edcbe8e8a54df9eb385','27', NULL, 125, 1);
INSERT /*+ IGNORE_ROW_ON_DUPKEY_INDEX (plugin_ns_rel(id)) */ INTO plugin_ns_rel (id,namespace_id,plugin_id, config, sort, enabled) VALUES ('1801816010882822165','649330b6c2d74edcbe8e8a54df9eb385','28', '{"port": 9500,"bossGroupThreadCount": 1,"maxPayloadSize": 65536,"workerGroupThreadCount": 12,"userName": "shenyu","password": "shenyu","isEncryptPassword": false,"encryptMode": "","leakDetectorLevel": "DISABLED"}', 125, 0);
INSERT /*+ IGNORE_ROW_ON_DUPKEY_INDEX (plugin_ns_rel(id)) */ INTO plugin_ns_rel (id,namespace_id,plugin_id, config, sort, enabled) VALUES ('1801816010882822166','649330b6c2d74edcbe8e8a54df9eb385','29', '{"topic":"shenyu-access-logging", "namesrvAddr": "localhost:9876","producerGroup":"shenyu-plugin-logging-rocketmq"}', 170, 0);
INSERT /*+ IGNORE_ROW_ON_DUPKEY_INDEX (plugin_ns_rel(id)) */ INTO plugin_ns_rel (id,namespace_id,plugin_id, config, sort, enabled) VALUES ('1801816010882822167','649330b6c2d74edcbe8e8a54df9eb385','3', NULL, 90, 0);
INSERT /*+ IGNORE_ROW_ON_DUPKEY_INDEX (plugin_ns_rel(id)) */ INTO plugin_ns_rel (id,namespace_id,plugin_id, config, sort, enabled) VALUES ('1801816010882822168','649330b6c2d74edcbe8e8a54df9eb385','30', '{"cacheType":"memory"}', 10, 0);
INSERT /*+ IGNORE_ROW_ON_DUPKEY_INDEX (plugin_ns_rel(id)) */ INTO plugin_ns_rel (id,namespace_id,plugin_id, config, sort, enabled) VALUES ('1801816010882822169','649330b6c2d74edcbe8e8a54df9eb385','31', NULL, 1, 0);
INSERT /*+ IGNORE_ROW_ON_DUPKEY_INDEX (plugin_ns_rel(id)) */ INTO plugin_ns_rel (id,namespace_id,plugin_id, config, sort, enabled) VALUES ('1801816010882822170','649330b6c2d74edcbe8e8a54df9eb385','32', '{"host":"localhost", "port": "9200"}', 190, 0);
INSERT /*+ IGNORE_ROW_ON_DUPKEY_INDEX (plugin_ns_rel(id)) */ INTO plugin_ns_rel (id,namespace_id,plugin_id, config, sort, enabled) VALUES ('1801816010882822171','649330b6c2d74edcbe8e8a54df9eb385','33', '{"host":"localhost", "port": "9092"}', 180, 0);
INSERT /*+ IGNORE_ROW_ON_DUPKEY_INDEX (plugin_ns_rel(id)) */ INTO plugin_ns_rel (id,namespace_id,plugin_id, config, sort, enabled) VALUES ('1801816010882822172','649330b6c2d74edcbe8e8a54df9eb385','34', '{"projectName": "shenyu", "logStoreName": "shenyu-logstore", "topic": "shenyu-topic"}', 175, 0);
INSERT /*+ IGNORE_ROW_ON_DUPKEY_INDEX (plugin_ns_rel(id)) */ INTO plugin_ns_rel (id,namespace_id,plugin_id, config, sort, enabled) VALUES ('1801816010882822173','649330b6c2d74edcbe8e8a54df9eb385','35', '{"topic":"shenyu-access-logging", "serviceUrl": "pulsar://localhost:6650"}', 185, 0);
INSERT /*+ IGNORE_ROW_ON_DUPKEY_INDEX (plugin_ns_rel(id)) */ INTO plugin_ns_rel (id,namespace_id,plugin_id, config, sort, enabled) VALUES ('1801816010882822174','649330b6c2d74edcbe8e8a54df9eb385','36', '{"endpoint": "ap-guangzhou.cls.tencentcs.com", "topic": "shenyu-topic"}', 176, 0);
INSERT /*+ IGNORE_ROW_ON_DUPKEY_INDEX (plugin_ns_rel(id)) */ INTO plugin_ns_rel (id,namespace_id,plugin_id, config, sort, enabled) VALUES ('1801816010882822175','649330b6c2d74edcbe8e8a54df9eb385','38', '{"host":"127.0.0.1","port":"8123","databse":"shenyu-gateway","username":"foo","password":"bar"}', 195, 0);
INSERT /*+ IGNORE_ROW_ON_DUPKEY_INDEX (plugin_ns_rel(id)) */ INTO plugin_ns_rel (id,namespace_id,plugin_id, config, sort, enabled) VALUES ('1801816010882822176','649330b6c2d74edcbe8e8a54df9eb385','39', '{"endpoint":"http://localhost:8000"}', 40, 0);
INSERT /*+ IGNORE_ROW_ON_DUPKEY_INDEX (plugin_ns_rel(id)) */ INTO plugin_ns_rel (id,namespace_id,plugin_id, config, sort, enabled) VALUES ('1801816010882822177','649330b6c2d74edcbe8e8a54df9eb385','4', '{"master":"mymaster","mode":"standalone","url":"192.168.1.1:6379","password":"abc"}', 60, 0);
INSERT /*+ IGNORE_ROW_ON_DUPKEY_INDEX (plugin_ns_rel(id)) */ INTO plugin_ns_rel (id,namespace_id,plugin_id, config, sort, enabled) VALUES ('1801816010882822178','649330b6c2d74edcbe8e8a54df9eb385','40', NULL, 150, 0);
INSERT /*+ IGNORE_ROW_ON_DUPKEY_INDEX (plugin_ns_rel(id)) */ INTO plugin_ns_rel (id,namespace_id,plugin_id, config, sort, enabled) VALUES ('1801816010882822179','649330b6c2d74edcbe8e8a54df9eb385','42', NULL, 320, 1);
INSERT /*+ IGNORE_ROW_ON_DUPKEY_INDEX (plugin_ns_rel(id)) */ INTO plugin_ns_rel (id,namespace_id,plugin_id, config, sort, enabled) VALUES ('1801816010882822180','649330b6c2d74edcbe8e8a54df9eb385','43', '{"totalSizeInBytes":"104857600","maxBlockMs":"0","ioThreadCount":"1","batchSizeThresholdInBytes":"524288","batchCountThreshold":"4096","lingerMs":"2000","retries":"100","baseRetryBackoffMs":"100","maxRetryBackoffMs":"100","enableLocalTest":"true","setGiveUpExtraLongSingleLog":"false"}', 177, 0);
INSERT /*+ IGNORE_ROW_ON_DUPKEY_INDEX (plugin_ns_rel(id)) */ INTO plugin_ns_rel (id,namespace_id,plugin_id, config, sort, enabled) VALUES ('1801816010882822181','649330b6c2d74edcbe8e8a54df9eb385','44', '{"defaultHandleJson":"{\"authorization\":\"test:test123\"}"}', 150, 0);
INSERT /*+ IGNORE_ROW_ON_DUPKEY_INDEX (plugin_ns_rel(id)) */ INTO plugin_ns_rel (id,namespace_id,plugin_id, config, sort, enabled) VALUES ('1801816010882822182','649330b6c2d74edcbe8e8a54df9eb385','45', '{"host":"127.0.0.1","port":5672,"password":"admin","username":"admin","exchangeName":"exchange.logging.plugin","queueName":"queue.logging.plugin","routingKey":"topic.logging","virtualHost":"/","exchangeType":"direct","durable":"true","exclusive":"false","autoDelete":"false"}', 171, 0);
INSERT /*+ IGNORE_ROW_ON_DUPKEY_INDEX (plugin_ns_rel(id)) */ INTO plugin_ns_rel (id,namespace_id,plugin_id, config, sort, enabled) VALUES ('1801816010882822183','649330b6c2d74edcbe8e8a54df9eb385','5', '{"multiSelectorHandle":"1","multiRuleHandle":"0"}', 200, 1);
INSERT /*+ IGNORE_ROW_ON_DUPKEY_INDEX (plugin_ns_rel(id)) */ INTO plugin_ns_rel (id,namespace_id,plugin_id, config, sort, enabled) VALUES ('1801816010882822184','649330b6c2d74edcbe8e8a54df9eb385','6', '{"register":"zookeeper://localhost:2181","multiSelectorHandle":"1","threadpool":"shared","corethreads":0,"threads":2147483647,"queues":0}', 310, 0);
INSERT /*+ IGNORE_ROW_ON_DUPKEY_INDEX (plugin_ns_rel(id)) */ INTO plugin_ns_rel (id,namespace_id,plugin_id, config, sort, enabled) VALUES ('1801816010882822185','649330b6c2d74edcbe8e8a54df9eb385','8', NULL, 200, 0);
INSERT /*+ IGNORE_ROW_ON_DUPKEY_INDEX (plugin_ns_rel(id)) */ INTO plugin_ns_rel (id,namespace_id,plugin_id, config, sort, enabled) VALUES ('1801816010882822186','649330b6c2d74edcbe8e8a54df9eb385','9', NULL, 130, 0);



INSERT /*+ IGNORE_ROW_ON_DUPKEY_INDEX("resource" (id)) */ INTO "resource"  (id, parent_id, title, name, url, component, resource_type, sort, icon, is_leaf, is_route, perms, status)VALUES ('1792749362445840479', '1357956838021890048', 'SHENYU.MENU.SYSTEM.MANAGMENT.PLUGINNAMESPACE', 'pluginNamespace', '/config/pluginNamespace', 'pluginNamespace', 1, 2, 'build', 0, 0, '', 1);
INSERT /*+ IGNORE_ROW_ON_DUPKEY_INDEX("resource" (id)) */ INTO "resource"  (id, parent_id, title, name, url, component, resource_type, sort, icon, is_leaf, is_route, perms, status)VALUES ('1792749362445840480', '1792749362445840479', 'SHENYU.BUTTON.SYSTEM.LIST', '', '', '', 2, 0, '', 1, 0, 'system:pluginNamespace:list', 1);
INSERT /*+ IGNORE_ROW_ON_DUPKEY_INDEX("resource" (id)) */ INTO "resource"  (id, parent_id, title, name, url, component, resource_type, sort, icon, is_leaf, is_route, perms, status)VALUES ('1792749362445840481', '1792749362445840479', 'SHENYU.BUTTON.SYSTEM.DELETE', '', '', '', 2, 1, '', 1, 0, 'system:pluginNamespace:delete', 1);
INSERT /*+ IGNORE_ROW_ON_DUPKEY_INDEX("resource" (id)) */ INTO "resource"  (id, parent_id, title, name, url, component, resource_type, sort, icon, is_leaf, is_route, perms, status)VALUES ('1792749362445840482', '1792749362445840479', 'SHENYU.BUTTON.SYSTEM.ADD', '', '', '', 2, 2, '', 1, 0, 'system:pluginNamespace:add', 1);
INSERT /*+ IGNORE_ROW_ON_DUPKEY_INDEX("resource" (id)) */ INTO "resource"  (id, parent_id, title, name, url, component, resource_type, sort, icon, is_leaf, is_route, perms, status)VALUES ('1792749362445840483', '1792749362445840479', 'SHENYU.BUTTON.SYSTEM.SYNCHRONIZE', '', '', '', 2, 3, '', 1, 0, 'system:pluginNamespace:modify', 1);
INSERT /*+ IGNORE_ROW_ON_DUPKEY_INDEX("resource" (id)) */ INTO "resource"  (id, parent_id, title, name, url, component, resource_type, sort, icon, is_leaf, is_route, perms, status)VALUES ('1792749362445840484', '1792749362445840479', 'SHENYU.BUTTON.SYSTEM.ENABLE', '', '', '', 2, 4, '', 1, 0, 'system:pluginNamespace:disable', 1);
INSERT /*+ IGNORE_ROW_ON_DUPKEY_INDEX("resource" (id)) */ INTO "resource"  (id, parent_id, title, name, url, component, resource_type, sort, icon, is_leaf, is_route, perms, status)VALUES ('1792749362445840485', '1792749362445840479', 'SHENYU.BUTTON.SYSTEM.EDIT', '', '', '', 2, 5, '', 1, 0, 'system:pluginNamespace:edit', 1);
INSERT /*+ IGNORE_ROW_ON_DUPKEY_INDEX("resource" (id)) */ INTO "resource"  (id, parent_id, title, name, url, component, resource_type, sort, icon, is_leaf, is_route, perms, status)VALUES ('1792749362445840486', '1792749362445840479', 'SHENYU.BUTTON.SYSTEM.RESOURCE', '', '', '', 2, 6, '', 1, 0, 'system:pluginNamespace:resource', 1);
