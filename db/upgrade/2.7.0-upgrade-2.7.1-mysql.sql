...
DELETE FROM `api_rule_relation` WHERE `rule_id` IN (
    SELECT `id` FROM (SELECT `r`.`id`
        ...
        WHERE `s`.`plugin_id` = '13') AS `tars_rule_ids`
);
...
DELETE FROM `rule` WHERE `selector_id` IN (
    SELECT `id` FROM (SELECT `id` FROM `selector` WHERE `plugin_id` = '13') AS `tars_selector_ids`
);
DELETE FROM `selector_condition` WHERE `selector_id` IN (
    SELECT `id` FROM (SELECT `id` FROM `selector` WHERE `plugin_id` = '13') AS `tars_selector_ids`
);
DELETE FROM `selector` WHERE `plugin_id` = '13';
DELETE FROM `meta_data` WHERE `rpc_type` = 'tars';
DELETE FROM `api` WHERE `rpc_type` = 'tars';
DELETE FROM `permission` WHERE `resource_id` IN ('1529402639284355075', '1529402639368241188', '1529402639368241189', '1529402639368241190', '1529402639368241191', '1529402639368241192', '1529402639368241193', '1529402639368241194', '1529402639368241195', '1529402639368241196');
DELETE FROM `resource` WHERE `id` IN ('1529402639284355075', '1529402639368241188', '1529402639368241189', '1529402639368241190', '1529402639368241191', '1529402639368241192', '1529402639368241193', '1529402639368241194', '1529402639368241195', '1529402639368241196');
DELETE FROM `namespace_plugin_rel` WHERE `plugin_id` = '13';
DELETE FROM `plugin_handle` WHERE `plugin_id` = '13';
DELETE FROM `plugin` WHERE `id` = '13';
ALTER TABLE `api` MODIFY COLUMN `rpc_type` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'http,dubbo,sofa,websocket,springCloud,motan,grpc';
