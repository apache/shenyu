...
/**
 * The type response time balance test.
 */
public class ResponseTimeLoadBalancerTest {
    ...
    public void testResponseTimeBalancer() throws Exception {
        buildUpstreamList();
        final ResponseTimeLoadBalancer responseTimeLoadBalancer = new ResponseTimeLoadBalancer();
        Upstream upstream = responseTimeLoadBalancer.doSelect(onlyOneList, "127.0.0.1");
        Assert.assertTrue(upstream != null);
