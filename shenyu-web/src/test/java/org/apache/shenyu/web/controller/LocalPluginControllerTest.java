...
public final class LocalPluginControllerTest {
    ...
    private void subscribeSelectorForTest(String name) {
    ...
    public void testDeleteRule() throws Exception{
        final String testSelectorId = "testSelectorId";
        final String testId = "testId";
        subscribeRuleForTest(testSelectorId, testId);
        assertThat(baseDataCache.obtainRuleData(testSelectorId))
                .isNotNull();
        this.mockMvc
    ...
    private void subscribeRuleForTest(String testSelectorId, String testId) {
        final RuleData ruleData = createRuleData(testSelectorId, testId);
        subscriber.onRuleSubscribe(ruleData);
    }

    private RuleData createRuleData(String testSelectorId, String testId) {
    ...
    private void subscribePluginForTest(String pluginName) {
        PluginData pluginData = createTestCleanPlugin(pluginName);
        subscriber.onSubscribe(pluginData);
    }

    private PluginData createTestCleanPlugin(String pluginName) {
