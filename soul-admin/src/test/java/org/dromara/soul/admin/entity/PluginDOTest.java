 ...
 * @author lw1243925457
 */
public final class PluginDOTest extends BaseDOTest<PluginDO> {

    @Override
    protected PluginDO getTargetClass() {
        final PluginDTO pluginDTO = new PluginDTO();
        pluginDTO.setName("name");
        pluginDTO.setConfig("config");
        pluginDTO.setEnabled(true);
        pluginDTO.setRole(1);
        return PluginDO.buildPluginDO(pluginDTO);
    }
}
