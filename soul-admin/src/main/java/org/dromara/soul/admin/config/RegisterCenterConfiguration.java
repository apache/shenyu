...
public class RegisterCenterConfiguration {
    ...
    static class ZookeeperRegister {
        ...
        @Bean
        @ConditionalOnMissingBean(ZookeeperRegisterService.class)
        public ZookeeperRegisterService zookeeperRegisterService(final ZkClient zkClient) {
            return new ZookeeperRegisterService(zkClient);
        }
    }
}
