...
CREATE TABLE IF NOT EXISTS `dashboard_user` (
  ...
  `enabled` tinyint(4) NOT NULL COMMENT 'whether this user is enabled or not',
...
CREATE TABLE IF NOT EXISTS `plugin` (
  ...
  `enabled` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'enable this plugin or not(1 enabled, 0 disabled)',
  `date_created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'create time',
  `date_updated` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'update  time',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `selector` (
  ...
  `plugin_id` varchar(128) NOT NULL COMMENT 'plugin id',
  `name` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'select name',
  `match_mode` int(2) NOT NULL COMMENT 'match mode(0 and mode, 1 or mode)',
  `type` int(4) NOT NULL COMMENT 'selector type(0 all flow, 1 customized flow)',
...
CREATE TABLE  IF NOT EXISTS `meta_data` (
  ...
  `rpc_ext` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT 'rpc extra information, json format',
  `date_created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'create time',
  `date_updated` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'update time',
