...
INSERT IGNORE INTO `resource` (`id`,`parent_id`,`title`,`name`,`url`,`component`,`resource_type`,`sort`,`icon`,`is_leaf`,`is_route`,`perms`,`status`,`date_created`,`date_updated`) VALUES ('1347051850521784320', '1347026805170909184', '添加hystrix选择器按钮', '', '', '', 2, 0, '', 1, 0, 'plugin:hystrixSelector:add', 1, '2021-01-07 13:26:03', '2021-01-15 23:09:55');
INSERT IGNORE INTO `resource` (`id`,`parent_id`,`title`,`name`,`url`,`component`,`resource_type`,`sort`,`icon`,`is_leaf`,`is_route`,`perms`,`status`,`date_created`,`date_updated`) VALUES ('1347051853025783808', '1347026805170909184', '删除hystrix选择器按钮', '', '', '', 2, 1, '', 1, 0, 'plugin:hystrixSelector:delete', 1, '2021-01-07 13:26:03', '2021-01-15 23:10:00');
INSERT IGNORE INTO `resource` (`id`,`parent_id`,`title`,`name`,`url`,`component`,`resource_type`,`sort`,`icon`,`is_leaf`,`is_route`,`perms`,`status`,`date_created`,`date_updated`) VALUES ('1347051855538171904', '1347026805170909184', '添加hystrix规则按钮', '', '', '', 2, 2, '', 1, 0, 'plugin:hystrixRule:add', 1, '2021-01-07 13:26:04', '2021-01-15 23:10:37');
INSERT IGNORE INTO `resource` (`id`,`parent_id`,`title`,`name`,`url`,`component`,`resource_type`,`sort`,`icon`,`is_leaf`,`is_route`,`perms`,`status`,`date_created`,`date_updated`) VALUES ('1347051857962479616', '1347026805170909184', '删除hystrix规则按钮', '', '', '', 2, 3, '', 1, 0, 'plugin:hystrixRule:delete', 1, '2021-01-07 13:26:05', '2021-01-15 23:10:07');
INSERT IGNORE INTO `resource` (`id`,`parent_id`,`title`,`name`,`url`,`component`,`resource_type`,`sort`,`icon`,`is_leaf`,`is_route`,`perms`,`status`,`date_created`,`date_updated`) VALUES ('1347051860495839232', '1347026805170909184', '同步hystrix按钮', '', '', '', 2, 4, '', 1, 0, 'plugin:hystrix:modify', 1, '2021-01-07 13:26:05', '2021-01-15 23:10:16');
...
INSERT IGNORE INTO `resource` (`id`,`parent_id`,`title`,`name`,`url`,`component`,`resource_type`,`sort`,`icon`,`is_leaf`,`is_route`,`perms`,`status`,`date_created`,`date_updated`) VALUES ('1350106119681622016', '1346776175553376256', 'SOUL.MENU.SYSTEM.MANAGMENT.ROLE', 'role', '/system/role', 'role', 1, 0, '', 0, 0, '', 1, '2021-01-15 23:42:37', '2021-01-15 23:46:31');
