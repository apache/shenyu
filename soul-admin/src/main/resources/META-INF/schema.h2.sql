...
INSERT INTO plugin_handle (`id`, `plugin_id`, `field`, `label`, `data_type`, `type`, `sort`, `ext_obj`, `date_created`, `date_updated`) VALUES ('40', '7', 'port', 'port', 2, 3, 3, NULL, '2020-12-25 00:00:00', '2020-12-25 00:00:00');
...
INSERT INTO `resource` (`id`, `parent_id`, `title`, `name`, `url`, `component`, `resource_type`, `sort`, `icon`, `is_leaf`, `is_route`, `perms`, `status`, `date_created`, `date_updated`) VALUES('1346777449787125760','1357956838021890048','SOUL.MENU.SYSTEM.MANAGMENT.PLUGIN','plugin','/config/plugin','plugin','1','2','','0','0','','1','2021-01-06 05:15:41','2021-01-15 23:46:35');
...
INSERT INTO `resource` (`id`, `parent_id`, `title`, `name`, `url`, `component`, `resource_type`, `sort`, `icon`, `is_leaf`, `is_route`, `perms`, `status`, `date_created`, `date_updated`) VALUES('1346777766301888512','1357956838021890048','SOUL.MENU.SYSTEM.MANAGMENT.AUTHEN','auth','/config/auth','auth','1','4','','0','0','','1','2021-01-06 05:16:56','2021-01-15 23:46:37');
INSERT INTO `resource` (`id`, `parent_id`, `title`, `name`, `url`, `component`, `resource_type`, `sort`, `icon`, `is_leaf`, `is_route`, `perms`, `status`, `date_created`, `date_updated`) VALUES('1346777907096285184','1357956838021890048','SOUL.MENU.SYSTEM.MANAGMENT.METADATA','metadata','/config/metadata','metadata','1','5','','0','0','','1','2021-01-06 05:17:30','2021-01-15 23:46:39');
INSERT INTO `resource` (`id`, `parent_id`, `title`, `name`, `url`, `component`, `resource_type`, `sort`, `icon`, `is_leaf`, `is_route`, `perms`, `status`, `date_created`, `date_updated`) VALUES('1346778036402483200','1357956838021890048','SOUL.MENU.SYSTEM.MANAGMENT.DICTIONARY','dict','/config/dict','dict','1','6','','0','0','','1','2021-01-06 05:18:00','2021-01-15 23:46:41');
INSERT INTO `resource` (`id`, `parent_id`, `title`, `name`, `url`, `component`, `resource_type`, `sort`, `icon`, `is_leaf`, `is_route`, `perms`, `status`, `date_created`, `date_updated`) VALUES('1347026381504262144','1346775491550474240','divide','divide','/plug/divide','divide','1','0','','0','0','','1','2021-01-06 21:44:51','2021-01-17 16:01:47');
...
INSERT INTO `resource` (`id`, `parent_id`, `title`, `name`, `url`, `component`, `resource_type`, `sort`, `icon`, `is_leaf`, `is_route`, `perms`, `status`, `date_created`, `date_updated`) VALUES('1347027647999520768','1346775491550474240','rate_limiter','rate_limiter','/plug/rate_limiter','rate_limiter','1','7','','0','0','','1','2021-01-06 21:49:53','2021-01-07 14:12:11');
...
INSERT INTO `resource` (`id`, `parent_id`, `title`, `name`, `url`, `component`, `resource_type`, `sort`, `icon`, `is_leaf`, `is_route`, `perms`, `status`, `date_created`, `date_updated`) VALUES('1350106119681622016','1346776175553376256','SOUL.MENU.SYSTEM.MANAGMENT.ROLE','role','/system/role','role','1','0','','0','0','','1','2021-01-15 23:42:37','2021-01-17 16:00:24');
...
INSERT INTO `resource` (`id`, `parent_id`, `title`, `name`, `url`, `component`, `resource_type`, `sort`, `icon`, `is_leaf`, `is_route`, `perms`, `status`, `date_created`, `date_updated`) VALUES('1355163372527050752','1346776175553376256','SOUL.MENU.SYSTEM.MANAGMENT.RESOURCE','resource','/system/resource','resource','1','2','','0','0','','1','2021-01-29 22:38:20','2021-02-06 14:04:23');
