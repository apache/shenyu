...
import org.apache.shenyu.integratedtest.common.dto.ShenyuRequestLog;
...
public class LoggingElasticSearchPluginTest extends AbstractPluginDataInit {
    ...
    public static void setup() throws IOException {
        String pluginResult = initPlugin(PluginEnum.LOGGING_ElasticSearch.getName(), "{\"host\":\"localhost\", \"port\": \"9200\"}");
