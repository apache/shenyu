...
/**
 * The integrated test for combination plugins about rewrite.
 */
public class RewriteTest extends AbstractPluginDataInit {
    ...
    @AfterAll
    public static void cleanRewrite() throws IOException {
