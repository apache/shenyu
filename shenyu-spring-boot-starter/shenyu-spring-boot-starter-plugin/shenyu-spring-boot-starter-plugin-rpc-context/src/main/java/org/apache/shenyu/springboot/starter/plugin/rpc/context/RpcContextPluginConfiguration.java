 ...
 */
@Configuration
public class RpcContextPluginConfiguration {
     ...
     */
    @Bean
    public ShenyuPlugin rpcContextPlugin() {
        return new RpcContextPlugin();
    }

    /**
     * RpcContext plugin data handler.
     *
     * @return the plugin data handler
     */
    @Bean
    public PluginDataHandler rpcContextPluginDataHandler() {
        return new RpcContextPluginDataHandler();
    }
}
