...
public class ShenyuClientRegisterSpringMVCServiceImpl extends AbstractShenyuClientRegisterService {
    ...
    public ShenyuClientRegisterSpringMVCServiceImpl(MetaDataMapper metaDataMapper, ApplicationEventPublisher eventPublisher, SelectorService selectorService, RuleService ruleService, RuleMapper ruleMapper, UpstreamCheckService upstreamCheckService, SelectorMapper selectorMapper, PluginMapper pluginMapper) {
