 ...
 */
@Repository
public interface AuthParamRepository extends JpaRepository<AuthParamDO, String> {

    /**
     * Find by auth id.
     *
     * @param authId the auth id
     * @return list of {@linkplain AuthParamDO}
     */
     ...
     * @return list of {@linkplain AuthParamDO}
     */
    List<AuthParamDO> findByAuthIdIn(List<String> authIdList);
}
