...
public class InstanceInfoReportEvent {
    ...
    public static final class Builder {
         ...
         */
        public InstanceInfoReportEvent.Builder instanceType(final String instanceType) {
            this.instanceType = instanceType;
            return this;
        }
         ...
         * @return InstanceInfoRegisterDTO.Builder
         */
        public InstanceInfoReportEvent.Builder instanceInfo(final String instanceInfo) {
            this.instanceInfo = instanceInfo;
            return this;
        }
         ...
         * @return InstanceInfoRegisterDTO.Builder
         */
        public InstanceInfoReportEvent.Builder instanceIp(final String instanceIp) {
            this.instanceIp = instanceIp;
            return this;
        }
         ...
         * @return InstanceInfoRegisterDTO.Builder
         */
        public InstanceInfoReportEvent.Builder instancePort(final String instancePort) {
            this.instancePort = instancePort;
            return this;
        }
         ...
         * @return InstanceInfoRegisterDTO.Builder
         */
        public InstanceInfoReportEvent.Builder namespaceId(final String namespaceId) {
            this.namespaceId = namespaceId;
            return this;
        }
