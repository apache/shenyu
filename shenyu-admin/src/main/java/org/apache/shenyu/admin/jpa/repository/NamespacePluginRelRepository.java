...
/**
 * The interface Namespace plugin rel repository.
 */
@Repository
public interface NamespacePluginRelRepository extends JpaRepository<NamespacePluginRelDO, String>, ExistProvider {
