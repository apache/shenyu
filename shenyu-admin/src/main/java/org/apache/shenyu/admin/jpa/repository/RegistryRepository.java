 ...
 */
@Repository
public interface RegistryRepository extends JpaRepository<RegistryDO, String>, ExistProvider {
    ...
    /**
     * Select by registry id.
     *
     * @param registryId registryId
     * @return {@linkplain RegistryDO}
     */
    Optional<RegistryDO> findByRegistryId(String registryId);
}
