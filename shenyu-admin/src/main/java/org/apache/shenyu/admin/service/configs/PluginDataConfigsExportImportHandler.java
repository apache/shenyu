...
@Component
public class PluginDataConfigsExportImportHandler implements ConfigsExportImportHandler {

    private final PluginService pluginService;

    public PluginDataConfigsExportImportHandler(final PluginService pluginService) {
        this.pluginService = pluginService;
    }

    @Override
    public ConfigsExportImportEnum configsEnum() {
        return ConfigsExportImportEnum.Plugin;
    }

    @Override
    public Optional<String> configsExport(final String namespaceId) {
        List<PluginVO> pluginDataList = pluginService.listAllDataByNamespaceId(namespaceId);
