...
public class ShenyuClientRegisterSpringCloudServiceImpl extends AbstractShenyuClientRegisterService {
    ...
    public ShenyuClientRegisterSpringCloudServiceImpl(MetaDataMapper metaDataMapper, ApplicationEventPublisher eventPublisher, SelectorService selectorService, RuleService ruleService, RuleMapper ruleMapper, UpstreamCheckService upstreamCheckService, SelectorMapper selectorMapper, PluginMapper pluginMapper) {
