 ...
 * ProxySelectorAddDTO.
 */
public class DiscoveryHandlerSelectorAddDTO implements Serializable {
     ...
     * id.
     */
    @Existed(provider = SelectorMapper.class, nullOfIgnore = true, message = "selector not exited")
    private String id;
