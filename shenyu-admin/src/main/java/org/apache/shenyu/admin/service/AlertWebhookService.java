...
public interface AlertWebhookService {
     ...
     * add webhook.
     * @return row int
     * @param alertWebhookDTO alertWebhookDTO
     */
    int addWebhook(AlertWebhookDTO alertWebhookDTO);

    /**
     * update webhook.
     * @return row int
     */
    int updateWebhook(AlertWebhookDTO alertWebhookDTO);

    /**
     * delete webhook.
     * @return row int
     */
    int deleteWebhook(String id);
