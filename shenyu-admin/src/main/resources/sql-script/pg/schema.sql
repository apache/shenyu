...
ELSE
	...
	PERFORM public.dblink_exec('init_conn',  'INSERT INTO "plugin" VALUES (''' || '13' || ''', ''' || 'tars' || ''', ''' || '{"multiSelectorHandle":"1","multiRuleHandle":"0","corethreads":0,"threads":2147483647,"queues":0,"threadpool":"cached"}' || ''', ''' || 'Proxy' || ''', 310, 0);');
...
ELSE
    ...
    PERFORM public.dblink_exec('init_conn',  'INSERT  INTO "plugin_handle" ( plugin_id , field , label , data_type , type , sort , ext_obj ) VALUES (''' || '13' || ''', ''' || 'corethreads' || ''', ''' || 'corethreads' || ''', 1, 3, 0, ''' || '{"required":"0","defaultValue":"0","placeholder":"corethreads","rule":""}' || ''');');
    PERFORM public.dblink_exec('init_conn',  'INSERT  INTO "plugin_handle" ( plugin_id , field , label , data_type , type , sort , ext_obj ) VALUES (''' || '13' || ''', ''' || 'threads' || ''', ''' || 'threads' || ''', 1, 3, 0, ''' || '{"required":"0","defaultValue":"2147483647","placeholder":"threads","rule":""}' || ''');');
    PERFORM public.dblink_exec('init_conn',  'INSERT  INTO "plugin_handle" ( plugin_id , field , label , data_type , type , sort , ext_obj ) VALUES (''' || '13' || ''', ''' || 'queues' || ''', ''' || 'queues' || ''', 1, 3, 0, ''' || '{"required":"0","defaultValue":"0","placeholder":"queues","rule":""}' || ''');');
    PERFORM public.dblink_exec('init_conn',  'INSERT  INTO "plugin_handle" ( plugin_id , field , label , data_type , type , sort , ext_obj ) VALUES (''' || '13' || ''', ''' || 'threadpool' || ''', ''' || 'threadpool' || ''', 3, 3, 0, ''' || '{"required":"0","defaultValue":"cached","placeholder":"threadpool","rule":""}' || ''');');
    ...
    PERFORM public.dblink_exec('init_conn',  'INSERT  INTO "plugin_handle" ( plugin_id , field , label , data_type , type , sort , ext_obj ) VALUES (''' || '17' || ''', ''' || 'corethreads' || ''', ''' || 'corethreads' || ''', 1, 3, 0, ''' || '{"required":"0","defaultValue":"0","placeholder":"corethreads","rule":""}' || ''');');
    PERFORM public.dblink_exec('init_conn',  'INSERT  INTO "plugin_handle" ( plugin_id , field , label , data_type , type , sort , ext_obj ) VALUES (''' || '17' || ''', ''' || 'threads' || ''', ''' || 'threads' || ''', 1, 3, 0, ''' || '{"required":"0","defaultValue":"2147483647","placeholder":"threads","rule":""}' || ''');');
    PERFORM public.dblink_exec('init_conn',  'INSERT  INTO "plugin_handle" ( plugin_id , field , label , data_type , type , sort , ext_obj ) VALUES (''' || '17' || ''', ''' || 'queues' || ''', ''' || 'queues' || ''', 1, 3, 0, ''' || '{"required":"0","defaultValue":"0","placeholder":"queues","rule":""}' || ''');');
    PERFORM public.dblink_exec('init_conn',  'INSERT  INTO "plugin_handle" ( plugin_id , field , label , data_type , type , sort , ext_obj ) VALUES (''' || '17' || ''', ''' || 'threadpool' || ''', ''' || 'threadpool' || ''', 3, 3, 0, ''' || '{"required":"0","defaultValue":"cached","placeholder":"threadpool","rule":""}' || ''');');
...
ELSE
    ...
    PERFORM public.dblink_exec('init_conn',  'INSERT  INTO  shenyu_dict  ( type , dict_code ,  dict_name ,  dict_value ,  "desc" ,  sort ,  enabled ) VALUES (''' || 'operator' || ''', ''' || 'OPERATOR' || ''', ''' || 'startsWith' || ''', ''' || 'startsWith' || ''', ''' || 'startsWith' || ''', 7, 1);');
    PERFORM public.dblink_exec('init_conn',  'INSERT  INTO  shenyu_dict  ( type , dict_code ,  dict_name ,  dict_value ,  "desc" ,  sort ,  enabled ) VALUES (''' || 'operator' || ''', ''' || 'OPERATOR' || ''', ''' || 'endsWith' || ''', ''' || 'endsWith' || ''', ''' || 'endWiths' || ''', 8, 1);');
