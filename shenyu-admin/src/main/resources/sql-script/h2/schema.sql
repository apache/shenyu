...
INSERT IGNORE INTO `shenyu_dict` (`id`, `type`,`dict_code`, `dict_name`, `dict_value`, `desc`, `sort`, `enabled`) VALUES ('1679002911061737473', 'discoveryMode', 'DISCOVERY_MODE', 'eureka', '{"eureka.client.refresh.interval": "10", "eureka.client.registryFetchIntervalSeconds": "10"}', 'discoery mode to link eureka', 0, 1);
