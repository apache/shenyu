...
INSERT IGNORE INTO `plugin` (`id`, `name`, `role`, `sort`, `config`,`enabled`, `date_created`, `date_updated`) VALUES ('6','dubbo','Proxy', 310,'{"register":"zookeeper://localhost:2181","multiSelectorHandle":"1","threadpool":"fixed","corethreads":200,"threads":200,"queues":0}', '0', '2018-06-23 10:26:41', '2018-06-11 10:11:47');;
