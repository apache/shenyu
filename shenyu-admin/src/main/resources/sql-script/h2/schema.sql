...
-- httpRecord
INSERT IGNORE INTO `plugin` (`id`, `name`, `config`, `role`, `sort`, `enabled`) VALUES ('67', 'httpRecord', null, 'HttpProcess', 200, 1);

INSERT IGNORE INTO plugin_handle (`id`, `plugin_id`,`field`,`label`,`data_type`,`type`,`sort`,`ext_obj`) VALUES ('2067162479970447360', '67', 'startTime', 'startTime', 1, 2, 0, '{"required":"1","defaultValue":"1780287614000","placeholder":"startTime","rule":""}');
INSERT IGNORE INTO plugin_handle (`id`, `plugin_id`,`field`,`label`,`data_type`,`type`,`sort`,`ext_obj`) VALUES ('2067162479970447361', '67', 'endTime', 'endTime', 1, 2, 0, '{"required":"1","defaultValue":"1780287814000","placeholder":"endTime","rule":""}');
INSERT IGNORE INTO plugin_handle (`id`, `plugin_id`,`field`,`label`,`data_type`,`type`,`sort`,`ext_obj`) VALUES ('2068305908214779904', '67', 'maxBodySize', 'maxBodySize', 1, 3, 0, '{"required":"0","defaultValue":"524288","rule":""}');
INSERT IGNORE INTO plugin_handle (`id`, `plugin_id`,`field`,`label`,`data_type`,`type`,`sort`,`ext_obj`) VALUES ('2068306022568284160', '67', 'batchSize', 'batchSize', 1, 3, 1, '{"required":"0","defaultValue":"100","rule":""}');
INSERT IGNORE INTO plugin_handle (`id`, `plugin_id`,`field`,`label`,`data_type`,`type`,`sort`,`ext_obj`) VALUES ('2068306133750894592', '67', 'batchIntervalMs', 'batchIntervalMs', 1, 3, 0, '{"required":"0","defaultValue":"5000","rule":""}');

INSERT IGNORE INTO `namespace_plugin_rel` (`id`,`namespace_id`,`plugin_id`, `config`, `sort`, `enabled`, `date_created`, `date_updated`) VALUES ('1801816010882822191','649330b6-c2d7-4edc-be8e-8a54df9eb385','67', NULL, 199, 1, '2022-05-25 18:02:53.000', '2026-05-25 09:27:25.639');

INSERT IGNORE INTO `permission` (`id`, `object_id`, `resource_id`, `date_created`, `date_updated`) VALUES ('2060675900525121540', '1346358560427216896', '2060959853814128640', '2023-08-31 06:59:01', '2023-08-31 06:59:01');
INSERT IGNORE INTO `permission` (`id`, `object_id`, `resource_id`, `date_created`, `date_updated`) VALUES ('2060675900525121541', '1346358560427216896', '2060553097071169537', '2023-08-31 07:22:07', '2023-08-31 07:22:07');
INSERT IGNORE INTO `permission` (`id`, `object_id`, `resource_id`, `date_created`, `date_updated`) VALUES ('2060675900525121542', '1346358560427216896', '2060553097071169538', '2023-08-31 07:14:26', '2023-08-31 07:14:26');
INSERT IGNORE INTO `permission` (`id`, `object_id`, `resource_id`, `date_created`, `date_updated`) VALUES ('2060675900525121543', '1346358560427216896', '2060553097071169539', '2023-08-31 07:22:07', '2023-08-31 07:22:07');
INSERT IGNORE INTO `permission` (`id`, `object_id`, `resource_id`, `date_created`, `date_updated`) VALUES ('2060675900525121544', '1346358560427216896', '2060553097071169541', '2023-08-31 07:18:37', '2023-08-31 07:18:37');
INSERT IGNORE INTO `permission` (`id`, `object_id`, `resource_id`, `date_created`, `date_updated`) VALUES ('2060675900525121545', '1346358560427216896', '2060553097071169542', '2023-08-31 07:18:37', '2023-08-31 07:18:37');
INSERT IGNORE INTO `permission` (`id`, `object_id`, `resource_id`, `date_created`, `date_updated`) VALUES ('2060675900525121546', '1346358560427216896', '2060553097071169543', '2023-08-31 07:18:37', '2023-08-31 07:18:37');
INSERT IGNORE INTO `permission` (`id`, `object_id`, `resource_id`, `date_created`, `date_updated`) VALUES ('2060675900525121547', '1346358560427216896', '2060553097071169544', '2023-08-31 07:18:37', '2023-08-31 07:18:37');
INSERT IGNORE INTO `permission` (`id`, `object_id`, `resource_id`, `date_created`, `date_updated`) VALUES ('2060675900525121548', '1346358560427216896', '2060553097071169545', '2023-08-31 07:18:37', '2023-08-31 07:18:37');
INSERT IGNORE INTO `permission` (`id`, `object_id`, `resource_id`, `date_created`, `date_updated`) VALUES ('2060675900525121549', '1346358560427216896', '2060553097071169546', '2023-08-31 07:18:37', '2023-08-31 07:18:37');
INSERT IGNORE INTO `permission` (`id`, `object_id`, `resource_id`, `date_created`, `date_updated`) VALUES ('2060675900525121560', '1346358560427216896', '2060553097071169550', '2023-08-31 07:22:07', '2023-08-31 07:22:07');

INSERT IGNORE INTO `resource` (`id`, `parent_id`, `title`, `name`, `url`, `component`, `resource_type`, `sort`, `icon`, `is_leaf`, `is_route`, `perms`, `status`) VALUES ('2060959853814128640', '1346775491550474240', 'httpRecord', 'httpRecord', '/plug/httpRecord', 'httpRecord', 1, 0, 'key', 0, 0, '', 1);
INSERT IGNORE INTO `resource` (`id`, `parent_id`, `title`, `name`, `url`, `component`, `resource_type`, `sort`, `icon`, `is_leaf`, `is_route`, `perms`, `status`) VALUES ('2060553097071169537', '2060959853814128640', 'SHENYU.BUTTON.PLUGIN.SELECTOR.ADD', '', '', '', 2, 0, '', 1, 0, 'plugin:httpRecordSelector:add', 1);
INSERT IGNORE INTO `resource` (`id`, `parent_id`, `title`, `name`, `url`, `component`, `resource_type`, `sort`, `icon`, `is_leaf`, `is_route`, `perms`, `status`) VALUES ('2060553097071169538', '2060959853814128640', 'SHENYU.BUTTON.PLUGIN.SELECTOR.QUERY', '', '', '', 2, 0, '', 1, 0, 'plugin:httpRecordSelector:query', 1);
INSERT IGNORE INTO `resource` (`id`, `parent_id`, `title`, `name`, `url`, `component`, `resource_type`, `sort`, `icon`, `is_leaf`, `is_route`, `perms`, `status`) VALUES ('2060553097071169539', '2060959853814128640', 'SHENYU.BUTTON.PLUGIN.SELECTOR.EDIT', '', '', '', 2, 0, '', 1, 0, 'plugin:httpRecordSelector:edit', 1);
INSERT IGNORE INTO `resource` (`id`, `parent_id`, `title`, `name`, `url`, `component`, `resource_type`, `sort`, `icon`, `is_leaf`, `is_route`, `perms`, `status`) VALUES ('2060553097071169541', '2060959853814128640', 'SHENYU.BUTTON.PLUGIN.SELECTOR.DELETE', '', '', '', 2, 0, '', 1, 0, 'plugin:httpRecordSelector:delete', 1);
INSERT IGNORE INTO `resource` (`id`, `parent_id`, `title`, `name`, `url`, `component`, `resource_type`, `sort`, `icon`, `is_leaf`, `is_route`, `perms`, `status`) VALUES ('2060553097071169542', '2060959853814128640', 'SHENYU.BUTTON.PLUGIN.RULE.ADD', '', '', '', 2, 0, '', 1, 0, 'plugin:httpRecordRule:add', 1);
INSERT IGNORE INTO `resource` (`id`, `parent_id`, `title`, `name`, `url`, `component`, `resource_type`, `sort`, `icon`, `is_leaf`, `is_route`, `perms`, `status`) VALUES ('2060553097071169543', '2060959853814128640', 'SHENYU.BUTTON.PLUGIN.RULE.QUERY', '', '', '', 2, 0, '', 1, 0, 'plugin:httpRecordRule:query', 1);
INSERT IGNORE INTO `resource` (`id`, `parent_id`, `title`, `name`, `url`, `component`, `resource_type`, `sort`, `icon`, `is_leaf`, `is_route`, `perms`, `status`) VALUES ('2060553097071169544', '2060959853814128640', 'SHENYU.BUTTON.PLUGIN.RULE.EDIT', '', '', '', 2, 0, '', 1, 0, 'plugin:httpRecordRule:edit', 1);
INSERT IGNORE INTO `resource` (`id`, `parent_id`, `title`, `name`, `url`, `component`, `resource_type`, `sort`, `icon`, `is_leaf`, `is_route`, `perms`, `status`) VALUES ('2060553097071169545', '2060959853814128640', 'SHENYU.BUTTON.PLUGIN.RULE.DELETE', '', '', '', 2, 0, '', 1, 0, 'plugin:httpRecordRule:delete', 1);
INSERT IGNORE INTO `resource` (`id`, `parent_id`, `title`, `name`, `url`, `component`, `resource_type`, `sort`, `icon`, `is_leaf`, `is_route`, `perms`, `status`) VALUES ('2060553097071169546', '2060959853814128640', 'SHENYU.BUTTON.PLUGIN.SYNCHRONIZE', '', '', '', 2, 0, '', 1, 0, 'plugin:httpRecord:modify', 1);
INSERT IGNORE INTO `resource` (`id`, `parent_id`, `title`, `name`, `url`, `component`, `resource_type`, `sort`, `icon`, `is_leaf`, `is_route`, `perms`, `status`) VALUES ('2060553097071169550', '2060959853814128640', 'SHENYU.BUTTON.PLUGIN.LIST', '', '', '', 2, 0, '', 1, 0, 'plugin:httpRecord:list', 1);
