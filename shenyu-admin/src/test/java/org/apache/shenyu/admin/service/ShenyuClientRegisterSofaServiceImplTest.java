...
/**
 * Test cases for ShenyuClientRegisterSofaServiceImplTest.
 */
...
public class ShenyuClientRegisterSofaServiceImplTest {
    ...
    @Before
    public void setup() {
        shenyuClientRegisterSofaService = new ShenyuClientRegisterSofaServiceImpl(metaDataService, selectorService, ruleService, pluginService);
    }

    @Test
    public void testRegister() {
        MetaDataRegisterDTO dto = buildMetaDataRegisterDTO();
        assertEquals(ShenyuResultMessage.SUCCESS, shenyuClientRegisterSofaService.register(dto));
    }
