...
public final class PluginControllerTest {
    ...
    public void testQueryPlugins() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.get("/plugin_template")
                        .param("name", "t_n")
                        .param("enabled", "1")
    ...
    public void testQueryAllPlugins() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.get("/plugin_template/all"))
                .andExpect(status().isOk())
                .andReturn();
    }
    ...
    public void testDetailPlugin() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.get("/plugin_template/{id}", "123"))
                .andExpect(status().isOk())
    ...
    public void testCreatePlugin() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.multipart("/plugin_template")
    ...
    public void testUpdatePlugin() throws Exception {
        ...
        when(pluginMapper.existed(pluginDTO.getId())).thenReturn(true);
        given(this.pluginService.createOrUpdate(pluginDTO)).willReturn(ShenyuResultMessage.UPDATE_SUCCESS);
        this.mockMvc.perform(MockMvcRequestBuilders.put("/plugin_template/{id}", pluginDTO.getId())
    ...
    public void testDeletePlugins() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.delete("/plugin_template/batch")
    ...
    public void testEnabled() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.post("/plugin_template/enabled")
                        .contentType(MediaType.APPLICATION_JSON)
