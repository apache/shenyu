...
public final class HttpLongPollingDataChangedListenerTest {
    ...
    public void testCompareChangedGroup() {
        ...
        this.httpServletRequest.setParameter(ConfigGroupEnum.CLUSTER.name(), "F1887D3F9E6EE7A32FE5E76F4AB80D57,1607068119");
        ...
        assertEquals("F1887D3F9E6EE7A32FE5E76F4AB80D57,1607068119", this.httpServletRequest.getParameter(ConfigGroupEnum.CLUSTER.name()));
