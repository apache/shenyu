...
public class RequestHandle {
     ...
     * @param cookie    cookie
     */
    public RequestHandle(final ShenyuRequestHeader header, final ShenyuRequestParameter parameter, final ShenyuCookie cookie) {
        this.header = header;
    ...
    public class ShenyuRequestHeader {
        ...
        public boolean equals(final Object o) {
            ...
            return Objects.equals(addHeaders, that.addHeaders)
                    && Objects.equals(replaceHeaderKeys, that.replaceHeaderKeys)
                    && Objects.equals(setHeaders, that.setHeaders)
                    && Objects.equals(removeHeaderKeys, that.removeHeaderKeys);
        }
    ...
    public class ShenyuRequestParameter {
        ...
        public boolean equals(final Object o) {
            ...
            return Objects.equals(addParameters, that.addParameters)
                    && Objects.equals(replaceParameterKeys, that.replaceParameterKeys)
                    && Objects.equals(setParameters, that.setParameters)
                    && Objects.equals(removeParameterKeys, that.removeParameterKeys);
        }
    ...
    public class ShenyuCookie {
        ...
        public boolean equals(final Object o) {
            ...
            return Objects.equals(addCookies, that.addCookies)
                    && Objects.equals(replaceCookieKeys, that.replaceCookieKeys)
                    && Objects.equals(setCookies, that.setCookies)
                    && Objects.equals(removeCookieKeys, that.removeCookieKeys);
        }
