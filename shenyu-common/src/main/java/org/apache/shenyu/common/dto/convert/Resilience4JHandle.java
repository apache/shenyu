...
public class Resilience4JHandle {
    ...
    public boolean equals(final Object o) {
        ...
        return timeoutDurationRate == that.timeoutDurationRate
                && limitRefreshPeriod == that.limitRefreshPeriod
                && limitForPeriod == that.limitForPeriod
                && circuitEnable == that.circuitEnable
                ...
                && waitIntervalFunctionInOpenState == that.waitIntervalFunctionInOpenState
    ...
    @Override
    public int hashCode() {
        return Objects.hash(timeoutDurationRate, limitRefreshPeriod, limitForPeriod, circuitEnable, timeoutDuration,
                fallbackUri, slidingWindowSize, slidingWindowType, minimumNumberOfCalls, waitIntervalFunctionInOpenState,
