...
public class HashedWheelTimer implements Timer {
    ...
    public HashedWheelTimer() {
        this(ShenyuThreadFactory.create("hashed-wheel-timer", false));
    }
    ...
    public HashedWheelTimer(final long tickDuration, final TimeUnit unit) {
        this(ShenyuThreadFactory.create("hashed-wheel-timer", false), tickDuration, unit);
    }
    ...
    public HashedWheelTimer(final long tickDuration, final TimeUnit unit, final int ticksPerWheel) {
        this(ShenyuThreadFactory.create("hashed-wheel-timer", false), tickDuration, unit, ticksPerWheel);
    }
     ...
     *                           being thrown. No maximum pending timeouts limit is assumed if this value is 0 or negative.
     * @throws NullPointerException     if either of {@code threadFactory} and {@code unit} is {@code null}
     * @throws IllegalArgumentException if either of {@code tickDuration} and {@code ticksPerWheel} is &lt;= 0
     */
    public HashedWheelTimer(
    ...
    private static HashedWheelBucket[] createWheel(final int ticksPerWheel) {
        ...
        int newTicksPerWheel = normalizeTicksPerWheel(ticksPerWheel);
    ...
    private static String simpleClassName(final Object o) {
        return simpleClassName(o.getClass());
    }
    
    private static String simpleClassName(final Class<?> clazz) {
        String className = clazz.getName();
        final int lastDotIndx = className.lastIndexOf('.');
        if (lastDotIndx > -1) {
            return className.substring(lastDotIndx + 1);
        }
        return className;
    }
    ...
    private static final class HashedWheelTimeout implements Timeout {
        ...
        /**
         * Instantiates a new Hashed wheel timeout.
         *
