...
public class HystrixHandle {
    ...
    public boolean equals(final Object o) {
        ...
        return maxConcurrentRequests == that.maxConcurrentRequests
                && errorThresholdPercentage == that.errorThresholdPercentage
                && requestVolumeThreshold == that.requestVolumeThreshold
                && sleepWindowInMilliseconds == that.sleepWindowInMilliseconds
                && timeout == that.timeout
                && executionIsolationStrategy == that.executionIsolationStrategy
