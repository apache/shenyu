...
/**
 * add test case for {@link PolarisCacheHandler}.
 */
public class PolarisCacheHandlerTest {
    ...
    private PolarisCacheHandler polarisCacheHandler;
    ...
    @Test
    public void testUpdatePluginMap() throws PolarisException {
        ...
        polarisCacheHandler = new PolarisCacheHandler(configFileService, new PluginDataSubscriber() {
            @Override
        ...
        polarisCacheHandler.updatePluginMap(pluginData);
    ...
    @Test
    public void testUpdateSelectorMap() throws PolarisException {
        ...
        polarisCacheHandler.updateSelectorMap(selectorDataParam);
        ...
        assertEquals(
                ...
                ImmutableMap.of(
                        ...
                        ImmutableList.of(selectorData1)).toString());
    }

    @Test
    public void testUpdateRuleMap() throws PolarisException {
        ...
        polarisCacheHandler.updateRuleMap(ruleDataParam);
        assertEquals(2, subscribeList.size());
        assertEquals(2, unsubscribeList.size());
        assertEquals(
                ...
                ImmutableMap.of(
                        ...
                        ImmutableList.of(ruleData2),
                        selectorId1,
                        ImmutableList.of(ruleData1)).toString());
    }

    @Test
    public void testUpdateMetaDataMap() throws PolarisException {
        ...
        polarisCacheHandler = new PolarisCacheHandler(configFileService, null, Lists.newArrayList(metaDataSubscriber),
                Collections.emptyList(), Collections.emptyList());
        polarisCacheHandler.updateMetaDataMap(metaDataParam);
        assertEquals(2, subscribeList.size());
        assertEquals(2, unsubscribeList.size());
        assertEquals(
    ...
    @Test
    public void testUpdateAuthMap() throws PolarisException {
        ...
        polarisCacheHandler = new PolarisCacheHandler(configFileService, null,
                Collections.emptyList(), Lists.newArrayList(authDataSubscriber), null);

        polarisCacheHandler.updateAuthMap(appAuthDataParam);
        assertEquals(2, subscribeList.size());
        assertEquals(2, unsubscribeList.size());
        assertEquals(
    ...
    @Test
    public void testWatcherData() throws PolarisException {
        String mockAppKey = "MOCK_APP_KEY";
        String mockAppKey2 = "MOCK_APP_KEY2";
        String mockAppSecret = "MOCK_APP_SECRET";
        AppAuthData appAuthData =
        ...
        PolarisCacheHandler.OnChange oc = polarisCacheHandler::updateAuthMap;
        polarisCacheHandler.watcherData(AUTH_DATA_ID_FILE_NAME, oc);
    }

    private void changePluginData(final List<PluginData> changed) throws PolarisException {
        updateDataMap(getConfig(PLUGIN_DATA_FILE_NAME));

        changed.forEach(plugin -> PLUGIN_MAP.put(plugin.getName(), plugin));

        publishConfig(PLUGIN_DATA_FILE_NAME, PLUGIN_MAP);
    }

    private void changeSelectorData(final List<SelectorData> changed) throws PolarisException {
        changeSelectorDataMap(getConfig(SELECTOR_DATA_FILE_NAME));
        ...
        publishConfig(SELECTOR_DATA_FILE_NAME, SELECTOR_MAP);
    }

    private void changeRuleData(final List<RuleData> changed) throws PolarisException {
        changeRuleDataMap(getConfig(RULE_DATA_FILE_NAME));
        ...
        publishConfig(RULE_DATA_FILE_NAME, RULE_MAP);
    }

    private void changeMetaData(final List<MetaData> changed) throws PolarisException {
        changeMetaDataMap(getConfig(META_DATA_FILE_NAME));
        ...
        publishConfig(META_DATA_FILE_NAME, META_DATA);
    }

    private void changeAuthData(final List<AppAuthData> changed) throws PolarisException {
        changeAppAuthDataMap(getConfig(AUTH_DATA_ID_FILE_NAME));

        changed.forEach(appAuth -> AUTH_MAP.put(appAuth.getAppKey(), appAuth));

        publishConfig(AUTH_DATA_ID_FILE_NAME, AUTH_MAP);
    }
