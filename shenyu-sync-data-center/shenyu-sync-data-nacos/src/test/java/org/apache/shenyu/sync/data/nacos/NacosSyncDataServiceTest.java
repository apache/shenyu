...
public final class NacosSyncDataServiceTest {
    ...
    public void testUpdatePluginMap() throws NacosException {
        ...
        nacosSyncDataService = new NacosSyncDataService(configService, new PluginDataSubscriber() {
            @Override
        ...
        nacosSyncDataService.subscriberPluginData(pluginData);
    ...
    public void testUpdateSelectorMap() throws NacosException {
        ...
        nacosSyncDataService.subscriberSelectorData(selectorDataParam);
    ...
    public void testUpdateRuleMap() throws NacosException {
        ...
        nacosSyncDataService.subscriberRuleData(ruleDataParam);
        assertEquals(2, subscribeList.size());
        assertEquals(2, unsubscribeList.size());
        assertEquals(
    ...
    public void testUpdateMetaDataMap() throws NacosException {
        ...
        nacosSyncDataService = new NacosSyncDataService(configService, null, Lists.newArrayList(metaDataSubscriber),
                Collections.emptyList(), Collections.emptyList(), Collections.emptyList());
        nacosSyncDataService.subscriberMetaData(metaDataParam);
        assertEquals(2, subscribeList.size());
        assertEquals(2, unsubscribeList.size());
        assertEquals(
    ...
    public void testUpdateAuthMap() throws NacosException {
        ...
        nacosSyncDataService = new NacosSyncDataService(configService, null,
                Collections.emptyList(), Lists.newArrayList(authDataSubscriber), null, null);

        nacosSyncDataService.subscriberAuthData(appAuthDataParam);
        assertEquals(2, subscribeList.size());
        assertEquals(2, unsubscribeList.size());
        assertEquals(
    ...
    public void testWatcherData() throws NacosException {
        ...
        NacosSyncDataService.OnChange oc = nacosSyncDataService::subscriberAuthData;
        nacosSyncDataService.startWatcherData(AUTH_DATA_ID, oc);
    }
    ...
    /**
     * Method under test: {@link NacosSyncDataService#close()}.
     */
    @Test
    void testClose() {
        NacosMockConfigService configService = new NacosMockConfigService();
        ...
        NacosSyncDataService nacosSyncDataService = new NacosSyncDataService(configService, null, metaDataSubscribers,
                authDataSubscribers, proxySelectorDataSubscribers, new ArrayList<>());
        nacosSyncDataService.close();
        assertNull(nacosSyncDataService.readData("Config Name"));
    }
}
