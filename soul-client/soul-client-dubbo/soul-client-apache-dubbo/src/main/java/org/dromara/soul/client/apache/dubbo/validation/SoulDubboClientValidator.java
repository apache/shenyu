 ...
 * @author KevinClair
 */
public class SoulDubboClientValidator implements Validator {
    private static final Logger logger = LoggerFactory.getLogger(SoulDubboClientValidator.class);
    ...
    public SoulDubboClientValidator(URL url) {
        this.clazz = ReflectUtils.forName(url.getServiceInterface());
        String jvalidation = url.getParameter("soulValidation");
