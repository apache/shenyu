...
package org.dromara.soul.plugin.sofa.context;
 ...
 * @author xiaoyu
 */
public class SofaSoulContextDecorator implements SoulContextDecorator {
    ...
    public SoulContext decorator(final SoulContext soulContext, final MetaData metaData) {
        ...
        soulContext.setRpcType(RpcTypeEnum.SOFA.getName());
        return soulContext;
    }
