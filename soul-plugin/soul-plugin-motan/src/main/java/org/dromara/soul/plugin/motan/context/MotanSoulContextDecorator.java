...
package org.dromara.soul.plugin.motan.context;
 ...
 * @author tydhot
 */
public class MotanSoulContextDecorator implements SoulContextDecorator {
    ...
    public SoulContext decorator(final SoulContext soulContext, final MetaData metaData) {
        ...
        soulContext.setRpcType(RpcTypeEnum.MOTAN.getName());
        return soulContext;
    }
