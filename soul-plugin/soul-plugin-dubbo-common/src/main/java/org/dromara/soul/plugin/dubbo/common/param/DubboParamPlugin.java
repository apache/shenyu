...
/**
 * The type dubbo param plugin.
 */
public class DubboParamPlugin implements SoulPlugin {

    private final List<HttpMessageReader<?>> messageReaders;

    /**
     * Instantiates a new dubbo param plugin.
     */
    public DubboParamPlugin() {
