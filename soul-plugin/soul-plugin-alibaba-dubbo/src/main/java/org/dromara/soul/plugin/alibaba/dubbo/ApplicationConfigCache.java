...
public final class ApplicationConfigCache {
    ...
    public ReferenceConfig<GenericService> build(final MetaData metaData) {
        ...
        try {
            AlibabaDubboParamInfo alibabaDubboParamInfo = GsonUtils.getInstance().fromJson(rpcExt, AlibabaDubboParamInfo.class);
            if (Objects.nonNull(alibabaDubboParamInfo)) {
                if (StringUtils.isNoneBlank(alibabaDubboParamInfo.getVersion())) {
                    reference.setVersion(alibabaDubboParamInfo.getVersion());
                }
                if (StringUtils.isNoneBlank(alibabaDubboParamInfo.getGroup())) {
                    reference.setGroup(alibabaDubboParamInfo.getGroup());
                }
                if (StringUtils.isNoneBlank(alibabaDubboParamInfo.getLoadbalance())) {
                    final String loadBalance = alibabaDubboParamInfo.getLoadbalance();
                ...
                Optional.ofNullable(alibabaDubboParamInfo.getTimeout()).ifPresent(reference::setTimeout);
                Optional.ofNullable(alibabaDubboParamInfo.getRetries()).ifPresent(reference::setRetries);
            }
        } catch (Exception e) {
