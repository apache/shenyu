...
import org.apache.shenyu.e2e.testcase.common.utils.ShenYuSpecUtils;
...
public class DividePluginCases implements ShenYuScenarioProvider {
    ...
    private ShenYuScenarioSpec testDivideWithUriEquals() {
        ShenYuBeforeEachSpec shenYuBeforeEachSpec = ShenYuBeforeEachSpec.builder()
                .addSelectorAndRule(
        ...
        ShenYuCaseSpec caseSpec = ShenYuCaseSpec.builder()
                ...
                .addNotExists("/get")
                .build();
        return ShenYuSpecUtils.buildShenYuScenarioSpec("single-divide uri =]", shenYuBeforeEachSpec, caseSpec, ShenYuAfterEachSpec.DEFAULT);
    ...
    private ShenYuScenarioSpec buildShenYuScenarioSpec(final String name,
