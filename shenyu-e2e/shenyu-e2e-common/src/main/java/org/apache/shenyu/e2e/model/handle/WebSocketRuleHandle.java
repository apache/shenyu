...
public class WebSocketRuleHandle implements RuleHandle{
     ...
     * no args constructor.
     */
    public WebSocketRuleHandle() {
    }

    public WebSocketRuleHandle(final Builder builder) {
    ...
    public static final class Builder {
         ...
         */
        public WebSocketRuleHandle build() {
            return new WebSocketRuleHandle(this);
        }
